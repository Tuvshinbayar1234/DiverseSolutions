        ...
        <div className="flex flex-col justify-center items-center py-10">
          <div className=" w-4/5 flex justify-evenly">
             <div className="flex flex-col">
               <h1>Нэр</h1>
               <input className=" w-72 py-4 outline-none border-b" placeholder="Name" />
             </div>
             <div className="flex flex-col">
               <h1>E-mail</h1>
               <input className="  w-72 py-4 outline-none border-b" placeholder="E-mail" />
             </div>
             <div className="flex flex-col">
               <h1>Phone</h1>
               <input className="  w-72 py-4 outline-none border-b" placeholder="Phone" />
             </div>
          </div>
          <div className="w-4/5 py-5">
            <div className="flex justify-evenly space-x-2">
              <div className="flex flex-col">
                <h1>Message</h1>
                <input className="py-4 outline-none border-b" placeholder="Message" style={{width: '670px'}} />
              </div>
